...
SetAcl (Get-ADUser "richard.croft") (Get-ADUser "claire.croft") "GenericAll" "None"
...
SetAcl (Get-ADUser "victor.ramos") (Get-ADGroup "Domain Admins") "GenericAll" "None"
...
SetAcl (Get-ADUser "steven.banks") (Get-ADComputer "DC01") "GenericAll" "None"
...
SetAcl (Get-ADUser "peter.bell") (Get-ADGroup "Domain Admins") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "tyler.croft") (Get-ADGroup "Domain Admins") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "steven.banks") (Get-ADGroup "Domain Admins") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "richard.croft") (Get-ADUser "james.croft") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "martin.price") (Get-ADGroup "Domain Admins") "WriteOwner" "None"
...
SetAcl (Get-ADUser "james.croft") (Get-ADUser "claire.croft") "GenericWrite" "None"
...
SetAcl (Get-ADUser "richard.croft") (Get-ADGroup "LeadershipBoard") "WriteDacl" "None"
